...
//   /// Loads detail data for a purchase order (bills + receiving notes).
//   Future<void> loadOrderDetail(String purchaseOrderId) async {
//     await _viewModel.loadOrderDetail(purchaseOrderId);
//     notifyListeners();
//   }

//   /// Creates a bill from the given [purchaseOrder].
//   Future<bool> createBillFromSelectedOrder({
//     required PurchaseOrder purchaseOrder,
//     required DateTime dueDate,
//     String? notes,
//   }) async {
//     final result = await _viewModel.createBillFromSelectedOrder(
...
//     final result = await _viewModel.deleteBill(billId);
//     notifyListeners();

//     return result;
//   }

//   /// Clears the selected order detail.
//   void clearOrderDetail() {
//     _viewModel.clearOrderDetail();
//     notifyListeners();
//   }
