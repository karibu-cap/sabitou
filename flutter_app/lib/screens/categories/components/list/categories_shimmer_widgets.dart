...
/// throughout the categories interface.
class CategorieShimmerWidgets {
  /// Creates a shimmer effect for the categories data table.
  ...
  /// Creates a shimmer effect for the categories statistics grid.
  ...
  /// Creates a shimmer effect for individual categorie cards.
  static Widget buildCategorieCardShimmer() {
    return Shimmer(
      duration: const Duration(seconds: 2),
      interval: const Duration(milliseconds: 500),
      color: Colors.grey[300] ?? Colors.transparent,
  ...
  /// Creates a shimmer effect for the categories list header.
