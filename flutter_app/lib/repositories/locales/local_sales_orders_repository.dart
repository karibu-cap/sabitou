...
// class LocalSalesOrdersRepository {
//   final _logger = LoggerApp('LocalOrdersRepository');

//   /// The hive database.
//   final hiveDatabase = GetIt.I.get<HiveDatabase>();

//   /// Constructs a new [LocalSalesOrdersRepository].
//   LocalSalesOrdersRepository();

//   /// Gets list of order with filter by supplier id.
//   Future<List<SalesOrder>> getOrdersByQuery(
//     FindSalesOrdersRequest request,
//   ) async {
//     try {
//       final allOrders = hiveDatabase.salesOrder.values.toList();
...
//       await hiveDatabase.salesOrder.put(request.order.refId, request.order);
