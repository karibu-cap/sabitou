...
class CustomAutoCompleteV2<T> extends StatefulWidget {
  ...
  /// Constructor for [CustomAutoCompleteV2].
  ...
  @override
  State<CustomAutoCompleteV2<T>> createState() =>
      _CustomAutoCompleteV2State<T>();
}

class _CustomAutoCompleteV2State<T> extends State<CustomAutoCompleteV2<T>> {
  ...
  @override
  void didUpdateWidget(CustomAutoCompleteV2<T> oldWidget) {
            ...
            ValueListenableBuilder(
              ...
              builder: (context, searchValue, child) {
                return FutureBuilder<List<T>>(
                  future: searchValue.text.isEmpty
                      ? Future.value([])
                      : _fetchOptions(searchValue.text),
