...
const StoreProductIsarSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'price': PropertySchema(id: 0, name: r'price', type: IsarType.long),
    r'refId': PropertySchema(id: 0, name: r'refId', type: IsarType.string),
    r'stockQuantity': PropertySchema(
      id: 0,
      name: r'stockQuantity',
      type: IsarType.long,
    ),
    r'storeId': PropertySchema(id: 0, name: r'storeId', type: IsarType.string),
