...
import '../../google/protobuf/descriptor.pbenum.dart' as $6;
...
class MessageConstraints extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MessageConstraints', package: const $pb.PackageName(_omitMessageNames ? '' : 'buf.validate'), createEmptyInstance: create)
    ...
    ..pc<Constraint>(3, _omitFieldNames ? '' : 'cel', $pb.PbFieldType.PM, subBuilder: Constraint.create)
    ..hasRequiredFields = false
  ;
...
class FieldConstraints extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'FieldConstraints', package: const $pb.PackageName(_omitMessageNames ? '' : 'buf.validate'), createEmptyInstance: create)
    ...
    ..pc<Constraint>(23, _omitFieldNames ? '' : 'cel', $pb.PbFieldType.PM, subBuilder: Constraint.create)
...
class PredefinedConstraints extends $pb.GeneratedMessage {
  ...
  factory PredefinedConstraints.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory PredefinedConstraints.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PredefinedConstraints', package: const $pb.PackageName(_omitMessageNames ? '' : 'buf.validate'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  PredefinedConstraints clone() => PredefinedConstraints()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  PredefinedConstraints copyWith(void Function(PredefinedConstraints) updates) => super.copyWith((message) => updates(message as PredefinedConstraints)) as PredefinedConstraints;
  ...
  static $pb.PbList<PredefinedConstraints> createRepeated() => $pb.PbList<PredefinedConstraints>();
  @$core.pragma('dart2js:noInline')
  static PredefinedConstraints getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<PredefinedConstraints>(create);
...
class TimestampRules extends $pb.GeneratedMessage {
  factory TimestampRules({
    ...
    $core.bool? gtNow,
    $4.Duration? within,
    $core.Iterable<$5.Timestamp>? example,
  }) {
    final $result = create();
    if (const_2 != null) {
      $result.const_2 = const_2;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TimestampRules', package: const $pb.PackageName(_omitMessageNames ? '' : 'buf.validate'), createEmptyInstance: create)
    ...
    ..pc<$5.Timestamp>(10, _omitFieldNames ? '' : 'example', $pb.PbFieldType.PM, subBuilder: $5.Timestamp.create)
    ..hasExtensions = true
  ;
  ...
  @$pb.TagNumber(10)
  $core.List<$5.Timestamp> get example => $_getList(8);
}
...
class Violation extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(2)
  set constraintId($core.String v) { $_setString(0, v); }
  @$pb.TagNumber(2)
...
class FieldPathElement extends $pb.GeneratedMessage {
  factory FieldPathElement({
    ...
    $6.FieldDescriptorProto_Type? fieldType,
    $6.FieldDescriptorProto_Type? keyType,
    $6.FieldDescriptorProto_Type? valueType,
    $fixnum.Int64? index,
    $core.bool? boolKey,
    $fixnum.Int64? intKey,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'FieldPathElement', package: const $pb.PackageName(_omitMessageNames ? '' : 'buf.validate'), createEmptyInstance: create)
    ...
    ..e<$6.FieldDescriptorProto_Type>(3, _omitFieldNames ? '' : 'fieldType', $pb.PbFieldType.OE, defaultOrMaker: $6.FieldDescriptorProto_Type.TYPE_DOUBLE, valueOf: $6.FieldDescriptorProto_Type.valueOf, enumValues: $6.FieldDescriptorProto_Type.values)
    ..e<$6.FieldDescriptorProto_Type>(4, _omitFieldNames ? '' : 'keyType', $pb.PbFieldType.OE, defaultOrMaker: $6.FieldDescriptorProto_Type.TYPE_DOUBLE, valueOf: $6.FieldDescriptorProto_Type.valueOf, enumValues: $6.FieldDescriptorProto_Type.values)
    ..e<$6.FieldDescriptorProto_Type>(5, _omitFieldNames ? '' : 'valueType', $pb.PbFieldType.OE, defaultOrMaker: $6.FieldDescriptorProto_Type.TYPE_DOUBLE, valueOf: $6.FieldDescriptorProto_Type.valueOf, enumValues: $6.FieldDescriptorProto_Type.values)
  ...
  @$pb.TagNumber(3)
  $6.FieldDescriptorProto_Type get fieldType => $_getN(2);
  @$pb.TagNumber(3)
  set fieldType($6.FieldDescriptorProto_Type v) { setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  $6.FieldDescriptorProto_Type get keyType => $_getN(3);
  @$pb.TagNumber(4)
  set keyType($6.FieldDescriptorProto_Type v) { setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(5)
  $6.FieldDescriptorProto_Type get valueType => $_getN(4);
  @$pb.TagNumber(5)
  set valueType($6.FieldDescriptorProto_Type v) { setField(5, v); }
  @$pb.TagNumber(5)
...
class Validate {
  ...
  static final predefined = $pb.Extension<PredefinedConstraints>(_omitMessageNames ? '' : 'google.protobuf.FieldOptions', _omitFieldNames ? '' : 'predefined', 1160, $pb.PbFieldType.OM, defaultOrMaker: PredefinedConstraints.getDefault, subBuilder: PredefinedConstraints.create);
