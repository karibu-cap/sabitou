...
class Store extends $pb.GeneratedMessage {
  factory Store({
    ...
    if (externalLinksIds != null) {
      $result.externalLinksIds = externalLinksIds;
    }
    if (businessId != null) {
  ...
  @$pb.TagNumber(7)
  set externalLinksIds($core.String v) { $_setString(4, v); }
  @$pb.TagNumber(7)
  $core.bool hasExternalLinksIds() => $_has(4);
  @$pb.TagNumber(7)
  void clearExternalLinksIds() => clearField(7);
  ...
  @$pb.TagNumber(8)
  void clearBusinessId() => clearField(8);
}
