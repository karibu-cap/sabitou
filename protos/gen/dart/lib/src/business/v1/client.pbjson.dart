...
const BusinessClient$json = {
  ...
  '2': [
    ...
    {'1': 'business_id', '3': 5, '4': 1, '5': 9, '8': {}, '10': 'businessId'},
  ],
  '8': [
    {'1': '_ref_id'},
    {'1': '_logo_link_id'},
...
final $typed_data.Uint8List businessClientDescriptor = $convert.base64Decode(
    'Cg5CdXNpbmVzc0NsaWVudBIaCgZyZWZfaWQYASABKAlIAFIFcmVmSWSIAQESGwoJZnVsbF9uYW'
    '1lGAIgASgJUghmdWxsTmFtZRIsChJleHRlcm5hbF9saW5rc19pZHMYAyADKAlSEGV4dGVybmFs'
    'TGlua3NJZHMSJQoMbG9nb19saW5rX2lkGAQgASgJSAFSCmxvZ29MaW5rSWSIAQESKwoLYnVzaW'
    '5lc3NfaWQYBSABKAlCCrpIB8gBAXICEANSCmJ1c2luZXNzSWRCCQoHX3JlZl9pZEIPCg1fbG9n'
    'b19saW5rX2lk');
...
final $typed_data.Uint8List createBusinessClientRequestDescriptor =
...
final $typed_data.Uint8List createBusinessClientResponseDescriptor =
    $convert.base64Decode(
        'ChxDcmVhdGVCdXNpbmVzc0NsaWVudFJlc3BvbnNlEicKCWNsaWVudF9pZBgBIAEoCUIKukgHyA'
        'EBcgIQA1IIY2xpZW50SWQ=');
...
final $typed_data.Uint8List getBusinessClientRequestDescriptor =
    $convert.base64Decode(
        'ChhHZXRCdXNpbmVzc0NsaWVudFJlcXVlc3QSJwoJY2xpZW50X2lkGAEgASgJQgq6SAfIAQFyAh'
        'ADUghjbGllbnRJZA==');
...
final $typed_data.Uint8List getBusinessClientResponseDescriptor =
    $convert.base64Decode(
...
final $typed_data.Uint8List updateBusinessClientRequestDescriptor =
    $convert.base64Decode(
...
final $typed_data.Uint8List updateBusinessClientResponseDescriptor =
    $convert.base64Decode(
...
final $typed_data.Uint8List deleteBusinessClientRequestDescriptor =
    $convert.base64Decode(
        'ChtEZWxldGVCdXNpbmVzc0NsaWVudFJlcXVlc3QSJwoJY2xpZW50X2lkGAEgASgJQgq6SAfIAQ'
        'FyAhADUghjbGllbnRJZA==');
...
final $typed_data.Uint8List deleteBusinessClientResponseDescriptor =
    $convert.base64Decode(
...
const $core.Map<$core.String, $core.dynamic> BusinessClientServiceBase$json = {
  ...
  '2': [
    {
      '1': 'CreateBusinessClient',
      '2': '.business.v1.CreateBusinessClientRequest',
      '3': '.business.v1.CreateBusinessClientResponse',
      '4': {}
    },
    {
      '1': 'GetBusinessClient',
...
const $core.Map<$core.String, $core.Map<$core.String, $core.dynamic>>
    BusinessClientServiceBase$messageJson = {
