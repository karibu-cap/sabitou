...
class User extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'User', package: const $pb.PackageName(_omitMessageNames ? '' : 'identity.v1'), createEmptyInstance: create)
    ...
    ..aOM<$4.ResourceLink>(8, _omitFieldNames ? '' : 'profileLink', subBuilder: $4.ResourceLink.create)
  ...
  @$pb.TagNumber(8)
  $4.ResourceLink get profileLink => $_getN(7);
  @$pb.TagNumber(8)
  set profileLink($4.ResourceLink v) { setField(8, v); }
  @$pb.TagNumber(8)
  $core.bool hasProfileLink() => $_has(7);
  @$pb.TagNumber(8)
  void clearProfileLink() => clearField(8);
  @$pb.TagNumber(8)
  $4.ResourceLink ensureProfileLink() => $_ensure(7);
