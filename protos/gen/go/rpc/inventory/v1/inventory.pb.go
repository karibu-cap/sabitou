...
type ListProductsBySupplierRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	SupplierId    string                 `protobuf:"bytes,1,opt,name=supplier_id,json=supplierId,proto3" json:"supplier_id,omitempty"` // ex. : "CMP-SUPPLIER-001"
	StoreId       *string                `protobuf:"bytes,2,opt,name=store_id,json=storeId,proto3,oneof" json:"store_id,omitempty"`    // Optional filter
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ListProductsBySupplierRequest) GetStoreId() string {
	if x != nil && x.StoreId != nil {
		return *x.StoreId
	}
	return ""
...
type ListProductsBySupplierResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Products      []*ProductBySupplier   `protobuf:"bytes,1,rep,name=products,proto3" json:"products,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *ListProductsBySupplierResponse) Reset() {
	*x = ListProductsBySupplierResponse{}
	mi := &file_inventory_v1_inventory_proto_msgTypes[16]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ListProductsBySupplierResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ListProductsBySupplierResponse) ProtoMessage() {}

func (x *ListProductsBySupplierResponse) ProtoReflect() protoreflect.Message {
	mi := &file_inventory_v1_inventory_proto_msgTypes[16]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ListProductsBySupplierResponse.ProtoReflect.Descriptor instead.
func (*ListProductsBySupplierResponse) Descriptor() ([]byte, []int) {
	return file_inventory_v1_inventory_proto_rawDescGZIP(), []int{16}
}

func (x *ListProductsBySupplierResponse) GetProducts() []*ProductBySupplier {
	if x != nil {
		return x.Products
	}
	return nil
...
type ProductBySupplier struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	StoreProduct  *StoreProduct          `protobuf:"bytes,1,opt,name=store_product,json=storeProduct,proto3" json:"store_product,omitempty"`    // StoreProduct details
	GlobalProduct *GlobalProduct         `protobuf:"bytes,2,opt,name=global_product,json=globalProduct,proto3" json:"global_product,omitempty"` // GlobalProduct details
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *ProductBySupplier) Reset() {
	*x = ProductBySupplier{}
...
func (x *ProductBySupplier) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ProductBySupplier) ProtoMessage() {}

func (x *ProductBySupplier) ProtoReflect() protoreflect.Message {
	mi := &file_inventory_v1_inventory_proto_msgTypes[17]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ProductBySupplier.ProtoReflect.Descriptor instead.
func (*ProductBySupplier) Descriptor() ([]byte, []int) {
	return file_inventory_v1_inventory_proto_rawDescGZIP(), []int{17}
}

func (x *ProductBySupplier) GetStoreProduct() *StoreProduct {
	if x != nil {
...
func (x *ProductBySupplier) GetGlobalProduct() *GlobalProduct {
	if x != nil {
		return x.GlobalProduct
	}
	return nil
...
func (x *AdjustInventoryRequest) GetStoreId() string {
	if x != nil {
		return x.StoreId
	}
	return ""
...
func (x *AdjustInventoryRequest) GetNotes() string {
	if x != nil {
		return x.Notes
	}
	return ""
...
func (x *AdjustInventoryRequest) GetBatchId() string {
	if x != nil {
		return x.BatchId
	}
	return ""
...
type AdjustInventoryResponse struct {
	...
	UpdatedLevel  *InventoryLevel        `protobuf:"bytes,2,opt,name=updated_level,json=updatedLevel,proto3" json:"updated_level,omitempty"` // Return the updated level
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *AdjustInventoryResponse) GetUpdatedLevel() *InventoryLevel {
	if x != nil {
...
const file_inventory_v1_inventory_proto_rawDesc = "" +
	...
	"stockValue\x12<\n" +
	"\fstock_status\x18\x05 \x01(\x0e2\x19.inventory.v1.StockStatusR\vstockStatus\"\x98\x03\n" +
	...
	"supplierId\x12\x1e\n" +
	"\bstore_id\x18\x02 \x01(\tH\x00R\astoreId\x88\x01\x01B\v\n" +
	"\t_store_id\"]\n" +
	"\x1eListProductsBySupplierResponse\x12;\n" +
	...
	"\rupdated_level\x18\x02 \x01(\v2\x1c.inventory.v1.InventoryLevelR\fupdatedLevel*\x96\x01\n" +
	...
	"\x19STOCK_STATUS_OUT_OF_STOCK\x10\x032\xc8\a\n" +
	...
	"\x1cGetProductTransactionHistory\x121.inventory.v1.GetProductTransactionHistoryRequest\x1a2.inventory.v1.GetProductTransactionHistoryResponse\x12s\n" +
	"\x16ListProductsBySupplier\x12+.inventory.v1.ListProductsBySupplierRequest\x1a,.inventory.v1.ListProductsBySupplierResponse\x12^\n" +
	"\x0fAdjustInventory\x12$.inventory.v1.AdjustInventoryRequest\x1a%.inventory.v1.AdjustInventoryResponseB\xbd\x01\n" +
...
var file_inventory_v1_inventory_proto_msgTypes = make([]protoimpl.MessageInfo, 20)
var file_inventory_v1_inventory_proto_goTypes = []any{
	...
	(*ListProductsBySupplierRequest)(nil),          // 17: inventory.v1.ListProductsBySupplierRequest
	(*ListProductsBySupplierResponse)(nil),         // 18: inventory.v1.ListProductsBySupplierResponse
	(*ProductBySupplier)(nil),                      // 19: inventory.v1.ProductBySupplier
	(*AdjustInventoryRequest)(nil),                 // 20: inventory.v1.AdjustInventoryRequest
	(*AdjustInventoryResponse)(nil),                // 21: inventory.v1.AdjustInventoryResponse
	(*timestamppb.Timestamp)(nil),                  // 22: google.protobuf.Timestamp
	(*StoreProduct)(nil),                           // 23: inventory.v1.StoreProduct
	(*GlobalProduct)(nil),                          // 24: inventory.v1.GlobalProduct
	(v1.TransactionType)(0),                        // 25: audits.v1.TransactionType
	(*v1.InventoryTransaction)(nil),                // 26: audits.v1.InventoryTransaction
}
var file_inventory_v1_inventory_proto_depIdxs = []int32{
	22, // 0: inventory.v1.Batch.expiration_date:type_name -> google.protobuf.Timestamp
	22, // 1: inventory.v1.Batch.received_at:type_name -> google.protobuf.Timestamp
	0,  // 2: inventory.v1.Batch.status:type_name -> inventory.v1.BatchStatus
	22, // 3: inventory.v1.InventoryLevel.last_updated:type_name -> google.protobuf.Timestamp
	...
	23, // 6: inventory.v1.InventoryLevelWithProduct.product:type_name -> inventory.v1.StoreProduct
	24, // 7: inventory.v1.InventoryLevelWithProduct.global_product:type_name -> inventory.v1.GlobalProduct
	1,  // 8: inventory.v1.InventoryLevelWithProduct.stock_status:type_name -> inventory.v1.StockStatus
	25, // 9: inventory.v1.GetInventoryTransactionHistoryRequest.transaction_type:type_name -> audits.v1.TransactionType
	...
	22, // 17: inventory.v1.GetResourceInventoryResponse.snapshot_date:type_name -> google.protobuf.Timestamp
	22, // 18: inventory.v1.GetProductTransactionHistoryRequest.start_date:type_name -> google.protobuf.Timestamp
	22, // 19: inventory.v1.GetProductTransactionHistoryRequest.end_date:type_name -> google.protobuf.Timestamp
	26, // 20: inventory.v1.GetProductTransactionHistoryResponse.transactions:type_name -> audits.v1.InventoryTransaction
	19, // 21: inventory.v1.ListProductsBySupplierResponse.products:type_name -> inventory.v1.ProductBySupplier
	23, // 22: inventory.v1.ProductBySupplier.store_product:type_name -> inventory.v1.StoreProduct
	24, // 23: inventory.v1.ProductBySupplier.global_product:type_name -> inventory.v1.GlobalProduct
	3,  // 24: inventory.v1.AdjustInventoryResponse.updated_level:type_name -> inventory.v1.InventoryLevel
	7,  // 25: inventory.v1.InventoryService.GetProductInventoryLevels:input_type -> inventory.v1.GetProductInventoryLevelsRequest
	9,  // 26: inventory.v1.InventoryService.CheckProductAvailability:input_type -> inventory.v1.CheckProductAvailabilityRequest
	11, // 27: inventory.v1.InventoryService.GetLowStockItems:input_type -> inventory.v1.GetLowStockItemsRequest
	13, // 28: inventory.v1.InventoryService.GetResourceInventory:input_type -> inventory.v1.GetResourceInventoryRequest
	5,  // 29: inventory.v1.InventoryService.GetRecentInventoryTransactions:input_type -> inventory.v1.GetInventoryTransactionHistoryRequest
	15, // 30: inventory.v1.InventoryService.GetProductTransactionHistory:input_type -> inventory.v1.GetProductTransactionHistoryRequest
	17, // 31: inventory.v1.InventoryService.ListProductsBySupplier:input_type -> inventory.v1.ListProductsBySupplierRequest
	20, // 32: inventory.v1.InventoryService.AdjustInventory:input_type -> inventory.v1.AdjustInventoryRequest
	8,  // 33: inventory.v1.InventoryService.GetProductInventoryLevels:output_type -> inventory.v1.GetProductInventoryLevelsResponse
	10, // 34: inventory.v1.InventoryService.CheckProductAvailability:output_type -> inventory.v1.CheckProductAvailabilityResponse
	12, // 35: inventory.v1.InventoryService.GetLowStockItems:output_type -> inventory.v1.GetLowStockItemsResponse
	14, // 36: inventory.v1.InventoryService.GetResourceInventory:output_type -> inventory.v1.GetResourceInventoryResponse
	6,  // 37: inventory.v1.InventoryService.GetRecentInventoryTransactions:output_type -> inventory.v1.GetInventoryTransactionHistoryResponse
	16, // 38: inventory.v1.InventoryService.GetProductTransactionHistory:output_type -> inventory.v1.GetProductTransactionHistoryResponse
	18, // 39: inventory.v1.InventoryService.ListProductsBySupplier:output_type -> inventory.v1.ListProductsBySupplierResponse
	21, // 40: inventory.v1.InventoryService.AdjustInventory:output_type -> inventory.v1.AdjustInventoryResponse
...
func file_inventory_v1_inventory_proto_init() {
	...
	file_inventory_v1_inventory_proto_msgTypes[15].OneofWrappers = []any{}
	type x struct{}
